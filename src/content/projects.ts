...
import Flora1 from "./Flora-Mapa.png";
import Flora2 from "./Flora-Home.png";
import Flora3 from "./Flora-MapaF.png";
import Flora4 from "./Flora-Form.png";
import Flora5 from "./Flora-Dashboard.png";
import FloraApp1 from "./FloraApp-Home.png";
import FloraApp2 from "./FloraApp-ZoomedIn.png";
import FloraApp3 from "./FloraApp-ListView.png";
import FloraApp4 from "./FloraApp-SelectedFarm.png";
import FloraApp5 from "./FloraApp-NewMonitoring.png";
import Alura1 from "./AluraC-Community.png";
import Alura2 from "./AluraC-Editor.png";
import Alura3 from "./AluraCMobile-Community.png";
import Alura4 from "./AluraCMobile-Editor.png";

export const projects: Record<string, Project> = {
  flora: {
    title: "Santos Lab - AG Platform Flora",
    description: `Flora is the internal name of the company's main software. It is a web platform for farmers and agronomists to explore data from different origins in their properties. It contemplates complex web maps, dashboard with unique charts, lots of forms and exotic components.
  ...
  floraMonitoring: {
    title: "Santos Lab - Pest and Prague Monitoring App",
  ...
  internalSantosLabServiceOrders: {
    title: "Santos Lab - Internal Service Orders Platform",
  ...
  aluraChallenge: {
    title: "Alura Challenge - Web Code Editor and Community",
    description:
